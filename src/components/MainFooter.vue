<template>
  ...
  <!--          <a href="#" @click.prevent="scrollToComponent('contact')" class="navTxt">Contact</a>-->
  <!--          &lt;!&ndash;            <a href="#" @click.prevent="scrollToComponent('thankYou')" class="navTxt">Thank you</a>&ndash;&gt;-->
